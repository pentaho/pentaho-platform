 ...
 * 
 * <p>
 * Example: When a servlet-based application starts up, a {@code ServletContextListener} calls {@link #startup()}. When
 * a user logs in, {@link #newTenant(String)} and {@link #onNewUser(String)} are called. Finally, the
