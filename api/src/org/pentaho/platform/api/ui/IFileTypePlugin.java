...
/**
 * This interface defines a file type plugin, which specifies the behavior
 * for viewing and editing specific file types
 * 
 * @author Will Gorman (wgorman@pentaho.com)
 */
public interface IFileTypePlugin {
  ...
  /**
   * return the open url pattern.  parameterized values include:
   *   {solution}
   *   {path}
   *   {name}
   *   
  ...
  /**
   * return the edit url pattern.  parameterized values include:
   *   {solution}
   *   {path}
   *   {name}
   *   
