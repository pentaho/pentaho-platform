...
public interface ISearchable {
  ...
  /**
   * @return Returns an array of the char/varchar columns that can be
   *         searched.
   */
  public String[] getSearchableColumns();

  /**
   * @return Returns the name of the hibernated object which will be used in
   *         the search.
   */
  public String getSearchableTable();

  /**
   * @return Returns the fully-package-qualified name of a named query in the
