...
public interface ISecurityHelper {
   ...
   * you want {@link #runAsUser(String, java.util.concurrent.Callable)}.</p>
   *
   ...
   * i.e. the given user will apply only to your {@link java.util.concurrent.Callable}, then the
   ...
   * @param callable  {@link java.util.concurrent.Callable#call()} contains the code you wish to run as the given user
