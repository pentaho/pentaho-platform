...
public class UnresolvedParameterException extends ActionSequenceException {
  ...
  public UnresolvedParameterException(String msg, Throwable cause, String sessionName, String instanceId, String actionSequenceName, IActionDefinition actionDefinition) {
    super(msg, cause, sessionName, instanceId, actionSequenceName, actionDefinition);
  }
  
  public UnresolvedParameterException(String msg, String sessionName, String instanceId, String actionSequenceName, IActionDefinition actionDefinition) {
