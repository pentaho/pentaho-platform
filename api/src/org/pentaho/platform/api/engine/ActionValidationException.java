...
public class ActionValidationException extends ActionSequenceException {
  ...
  public ActionValidationException(String msg, Throwable cause, String sessionName, String instanceId, String actionSequenceName, String actionDescription, String componentName) {
    super(msg, cause, sessionName, instanceId, actionSequenceName, actionDescription, componentName);
  }
  
  public ActionValidationException(String msg, Throwable cause, String sessionName, String instanceId, String actionSequenceName, IActionDefinition actionDefinition) {
    super(msg, cause, sessionName, instanceId, actionSequenceName, actionDefinition);
  }
  
  public ActionValidationException(String msg, String sessionName, String instanceId, String actionSequenceName, IActionDefinition actionDefinition) {
