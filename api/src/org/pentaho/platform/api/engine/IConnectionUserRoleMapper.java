...
/**
 * This interface provides for mapping a Platform user to a connection user, or a users' roles to known/valid roles for
 * a connection.
 * 
 */
public interface IConnectionUserRoleMapper {
   ...
   * PentahoAccessControlException - If null or empty array is returned, then no mapping is required, and connection can
   * use defaults
   * 
   * @param userSession
   *          The users' Session
