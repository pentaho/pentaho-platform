...
public interface IUserRoleDao {
  ...
  /**
   * Update the password of an existing user under a specified tenant. If the tenant is null
   * then it will try to update the password of an existing user under a default tenant
   * @param tenant
   * @param userName
   * @param password
  ...
  /**
   * Update the user description of an existing user under a speficied tenant. If the tenant is null
   * then it will try to update the user description of an existing user under a default tenant
   * @param tenant
   * @param userName
   * @param description
   * @throws NotFoundException
  ...
  /**
   * Retrieve the user from a specified tenant of the repository. If the tenant is null
   * then it will try to retrieve the user from a default tenant of the repository.
   * @param tenant
   * @param name
   * @return pentaho user
   * @throws UncategorizedUserRoleDaoException
  ...
  /**
   * Retrieve all the users from the specified tenant of a repository. If the tenant is 
   * null then it will try to retrieve all the users from the default tenant.
   * @param tenant
  ...
  /**
   * Retrieve all the users from the specified tenant of a repository . If the tenant is null then it will try to retrieve all the users from the default tenant.
   * If includeSubtenants is true, then it will retrieve all the users from the current specified tenant and its subtenants. 
   * @param tenant
  ...
  /**
   * Update the role description of a given role under a specific tenant. If the tenant is null, then it will search for the role in the default tenant
   * and update the description there
   * @param tenant
   * @param roleName
   * @param description
   * @throws NotFoundException
  ...
  /**
   * Retrieves the role with a given name from the specified tenant. If the tenant is null, then it will retrieve the role from the default tenant
   * @param tenant
   * @param name
   * @return pentaho role
   * @throws UncategorizedUserRoleDaoException
  ...
  /**
   * Retrieve all the role from the specified tenant. If the tenant is null, then it will retrieve all the roles from the default tenant
   * 
   * @param tenant
   * @return pentaho role list
   * @throws UncategorizedUserRoleDaoException
  ...
  /**
   * Retrieve all the roles from the specified tenant. If the includeSubtenants is "true" then it will get all the role from the subtenants as well 
   * 
   * @param tenant
   * @param includeSubtenants
   * @return pentaho role list
  ...
  /**
   * Assign list of user names to a particular role in a specified tenant. If the tenant is null, then it will search for this role in a default tenant
   * 
   * @param tenant
   * @param roleName
   * @param memberUserNames
  ...
  /**
   * Assign a list of roles to a particular user in a specified tenant. If the tenant is null, then it will search for this user in a default tenant
   * 
   * @param tenant
   * @param userName
   * @param roles
  ...
  /**
   * Retrieves the list of users associated to a particular role in a given tenant. If the tenant is null, then it will get role members in a default tenant
   * 
   * @param tenant
   * @param roleName
   * @return pentaho user list
  ...
  /**
   * Retrieves the list of roles associated to a particular user in a given tenant. If the tenant is null, then it will get user roles in a default tenant
   * 
   * @param tenant
   * @param userName
   * @return pentaho role list
