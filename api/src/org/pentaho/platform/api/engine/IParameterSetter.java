 ...
 * Some parameter providers allow setting and updating values.
 * 
 * @author jdixon
 */
...
public interface IParameterSetter extends IParameterProvider {
   ...
   * @param value The <tt>String</tt> value to set
   */
   ...
   * @param name name of the parameter to set
   * @param value The <tt>Date</tt> value to set
   */
   ...
   * @param name name of the parameter to set
   * @param value The <tt>Object</tt> value to set
   */
