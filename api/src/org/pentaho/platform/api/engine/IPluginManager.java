...
public interface IPluginManager {
   ...
   * 
   * @param classLoader
   *          The classloader for the plugin, also used to load all plugin resources
   ...
   * 
   * @param pluginId
   *          the ID of the plugin to find settings for
   * @param key
   ...
   * @param path
   *          a path relative to the plugin folder to check for public availability
