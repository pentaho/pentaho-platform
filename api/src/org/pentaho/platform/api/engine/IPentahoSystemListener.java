...
/**
 * Classes that implement this interface can be notified about key system
 * events, in order to perform one-time operations such as initialization,
 * maintenance or other tasks.
 * 
 * @version 1.0
 */
