...
boolean isDataIntegrationServer = ServerTypeUtil.isDataIntegrationServer();
boolean showUsers = !isDataIntegrationServer && Boolean.parseBoolean(PentahoSystem.getSystemSetting("login-show-sample-users-hint", "true"));
