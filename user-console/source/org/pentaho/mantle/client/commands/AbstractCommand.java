...
/**
 * This abstract class needs to be extend when using any command that requires server authentication. The execute method first check whether the user is
 * authenticated or not and then if the user is authentication is performs the command described in the performOperation method, otherwise the login screen will
...
public abstract class AbstractCommand implements Command {
  ...
  /**
   * This is an abstract method which the extending class with implement with logic of performing specific operation
   * 
   * */
