        ...
        public void onResponseReceived(Request request, Response response) {
          ...
          if (updates.getLength() > 0) {
            ...
            for (int i = 0; i < updates.getLength(); i++) {
              ...
              updateTable.setWidget(i + 1, 3,
                  new HTML("<A HREF=\"" + downloadURL + "\" target=\"_blank\" title=\"" + downloadURL + "\">" + Messages.getString("download") + "</A>")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
            ...
            PromptDialogBox versionPromptDialog = new PromptDialogBox(
