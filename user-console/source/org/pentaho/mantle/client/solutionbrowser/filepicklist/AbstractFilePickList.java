...
public abstract class AbstractFilePickList<T extends IFilePickItem> {
	...
	/**
	 * If the object is already in the list it will be removed first and the index
	 * adjusted accordingly.  If maxSize is positive and adding the item would 
	 * exceed maxSize, then the item will not be added.
	 *  
	 * @param index
	 * @param pickListItem
	 */
	...
	/**
	 * helper method for debugging. Use <code>stringify()</code> for formal JSON
	 * conversion.
	 */
