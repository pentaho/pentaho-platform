...
%>
  <script src="https://players.brightcove.net/4680021553001/default_default/index.min.js"></script>
<% } else { %>
  <script src="http://players.brightcove.net/4680021553001/default_default/index.min.js"></script>
<% } %>
                    ...
                    <a href="javascript:Home.openRepositoryFile('{{escapeQuotes fullPath}}', 'run')" title='{{title}}'>
                      <div class="row-fluid">
                        <div class="span10 ellipsis">
                          ...
                          {{#if unknownType}} <i class="pull-left content-icon file-unknown"></i> {{/if}}
