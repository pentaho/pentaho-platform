...
public class JaxBUtil {
  ...
  /**
   * Returns an object that should match the <code>in</code> object value-wise, but
   * is actually created by JAXB.  JAXB will marshall the <code>in</code> object
   * to XML, print it to stdout, and hydrate an object of the same type from the XML.
   * @param <T>  the type to marshall and unmarshall to and from XML
   * @param in  the object to marshall to XML
   * @param classes  additional classes referred to by the <code>in</code> object
