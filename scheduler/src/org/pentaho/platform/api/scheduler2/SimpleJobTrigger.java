...
/**
 * A simple way of specifying a schedule on which a job will fire as opposed to {@link ComplexJobTrigger}.
 * The {@link SimpleJobTrigger} can meet your needs if you are looking for a way to have a job start,
 * execute a set number of times on a regular interval and then end either after a specified number
 * of runs or at an end date.
 * @author aphillips
 */
@XmlRootElement
