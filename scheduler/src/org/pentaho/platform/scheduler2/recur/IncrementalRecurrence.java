...
/**
 * Used to specify incremental dates or times. For example an incremental recurrence with 1 as a starting
 * value and 3 as an increment translates to 1, 4, 7, etc. The time units may represent years,
