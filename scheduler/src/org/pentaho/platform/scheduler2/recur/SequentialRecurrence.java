...
/**
 * Used to specify a sequence of dates or times from first value through and including the last value. The sequence may represent years,
...
public class SequentialRecurrence implements ITimeRecurrence {
   ...
   * @param lastValue the last value in the sequence
   */
