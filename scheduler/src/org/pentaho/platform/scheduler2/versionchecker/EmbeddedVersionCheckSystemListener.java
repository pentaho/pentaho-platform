...
public class EmbeddedVersionCheckSystemListener implements IPentahoSystemListener {
  ...
  /**
   * This is a direct copy of VersionCheckSystemListener except that the
   * mechanism for talking to quartz goes through the PentahoSystem factory
   */
  ...
  protected int calculateRequestFlags() {
    ...
    int versionRequestFlags = (requestMajorReleases ? 4 : 0) + (requestMinorReleases ? 8 : 0) + 
