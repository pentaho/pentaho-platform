...
public class QuartzJobKey {
   ...
   * @param jobName the user-provided job name
   * @param username the user who is executing this job
  ...
  public static QuartzJobKey parse(String jobId) throws SchedulerException {
    ...
    if (elements == null || elements.length < 3) {
      throw new SchedulerException(MessageFormat.format(Messages.getInstance().getErrorString("QuartzJobKey.ERROR_0002"), jobId)); //$NON-NLS-1$
    }
