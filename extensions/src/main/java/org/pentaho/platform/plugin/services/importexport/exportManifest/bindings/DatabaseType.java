...
public class DatabaseType {
  ...
  public static class DefaultOptions {
    ...
    protected List<DatabaseType.DefaultOptions.Entry> entry;
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link DatabaseType.DefaultOptions.Entry }
     */
    public List<DatabaseType.DefaultOptions.Entry> getEntry() {
      if ( entry == null ) {
        entry = new ArrayList<>();
      }
      return this.entry;
