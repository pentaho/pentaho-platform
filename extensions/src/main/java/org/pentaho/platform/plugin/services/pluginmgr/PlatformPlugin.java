...
public class PlatformPlugin implements IPlatformPlugin, IPentahoInitializer {
   ...
   */
  private final Pattern RESOURCE_BUNDLE_KEY_PATTERN = Pattern.compile( "\\$\\{([^}]+)\\}" );
   ...
   */
  public void setResourceBundleClassName( @NonNull String className ) {
   ...
   */
  @Override
  public void setResourceBundleProvider( @NonNull IResourceBundleProvider provider ) {
