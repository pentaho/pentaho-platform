...
public class SystemUtils {
  ...
  public static boolean canUpload( String uploadDir ) {
    ...
    // check if the user is admin or has publish permission or the user is importing to his home folder
  ...
  public static boolean canDownload( String path ) {
    ...
    // check if the user is admin, or has download-roles, the user is downloading from their home folder
    return policy.isAllowed( AdministerSecurityAction.NAME )
      || hasDownloadRole()
  ...
  public static boolean validateAccessToHomeFolder( String path ) {
    ...
    // check if path full path is the user home folder path
    if ( fullPath.equals( userHomeFolderPath ) ) {
      return true;
    }

    // check if path full path is a subpath of the user home folder path
