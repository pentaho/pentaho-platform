  ...
  public void doFilter (final ServletRequest request, final ServletResponse response, final FilterChain chain)
    ...
    if (isRequestParameterAuthenticationEnabled) {
      ...
      HttpServletRequest wrapper =
              (HttpServletRequest) MultiReadHttpServletRequestWrapper.wrap ((javax.servlet.http.HttpServletRequest) request);
      ...
      if ((username != null) && (password != null)) {
        ...
        if ((existingAuth == null) || !existingAuth.getName ().equals (username)
          ...
          authRequest.setDetails (new WebAuthenticationDetails ((jakarta.servlet.http.HttpServletRequest) wrapper));
          ...
          try {
            ...
            if (ignoreFailure) {
              ...
              try {
                authenticationEntryPoint.commence ((jakarta.servlet.http.HttpServletRequest) wrapper,
                        (jakarta.servlet.http.HttpServletResponse) response, failed);
