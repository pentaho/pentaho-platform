 ...
 * parameter <b>_TRUST_USER_</b>. It will conditionally look for the parameter
 * in the HTTP Header too. It then passes the request down the servlet
 ...
 * <p>
 * 
 * The parameter that this filter looks for can be configured in the init parameters, 
 * as well as whether to check the request headers. The following shows the defaults
 * used if these settings aren't provided.
 * 
 * <pre>
 *   &lt;init-param&gt;
