...
public class BlockoutResource extends AbstractJaxRSResource {
  ...
  public BlockStatusProxy getBlockStatus( JobScheduleRequest request ) throws UnifiedRepositoryException,
    ...
    Boolean partiallyBlocked =
        manager.isPartiallyBlocked( SchedulerResourceUtil.convertScheduleRequestToJobTrigger( request, scheduler ) );
    if ( partiallyBlocked ) {
      totallyBlocked =
          !manager.willFire( SchedulerResourceUtil.convertScheduleRequestToJobTrigger( request, scheduler ) );
    }
