...
public class UserRoleDaoResource extends AbstractJaxRSResource {
  ...
  public RoleListWrapper getRoles() throws Exception {
    IUserRoleDao roleDao = PentahoSystem.get(IUserRoleDao.class, "userRoleDaoProxy", PentahoSessionHolder.getSession());
    return new RoleListWrapper(UserRoleDaoUtil.roleListNames(roleDao.getRoles()));
  ...
  public UserListWrapper getUsers() throws Exception {
    IUserRoleDao roleDao = PentahoSystem.get(IUserRoleDao.class, "userRoleDaoProxy", PentahoSessionHolder.getSession());
    return new UserListWrapper(UserRoleDaoUtil.userListUserNames(roleDao.getUsers()));
  ...
  public RoleListWrapper getPermissionRoles() throws Exception {
    IUserRoleDao roleDao = PentahoSystem.get(IUserRoleDao.class, "userRoleDaoProxy", PentahoSessionHolder.getSession());
    List<String> allRoles = UserRoleDaoUtil.roleListNames(roleDao.getRoles());
