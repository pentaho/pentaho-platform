 ...
 * This class should not installed in production environments. This 
 * is for samples / demoing only.
 * 
 * You typically will configure a ServletContext parameter in your web.xml,
 * named "hsqldb-databases" with a value that follows this format:
 * dbName@../path/to/database,@otherDbName@../path/to/other/database
 *
 */
