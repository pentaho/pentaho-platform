  ...
  protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      if (StringUtils.isEmpty(pathInfo)) {
        logger.error(Messages.getInstance().getErrorString("GenericServlet.ERROR_0005_NO_RESOURCE_SPECIFIED")); //$NON-NLS-1$
      ...
      String pluginId = pluginManager.getServicePlugin(pathInfo);
        ...
        // it.  the correct way is to look up a content generator by pluginManager.getContentGenerator(type, perspectiveName)
