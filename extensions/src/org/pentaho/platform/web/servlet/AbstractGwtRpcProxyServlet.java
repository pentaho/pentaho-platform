...
public abstract class AbstractGwtRpcProxyServlet extends RemoteServiceServlet {
   ...
   * @param servletContextPath the portion of the http request path beyond the servlet context, used to uniquely identify the target impl
   * @return the object that handles the request
   * @throws GwtRpcProxyException if no target can be found
   */
   ...
   * context in web.xml, then this method will return "testservice" upon a request to 
