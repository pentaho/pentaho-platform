...
public class GeneratedContentCleaner implements IAction {
   ...
   * Generated content is determined by using file metadata.  If a file contains the "RESERVEDMAPKEY_LINEAGE_ID"
   * key in the metadata, then when know it is generated content (created from scheduler or run in background)
   */
  ...
  /*
   * This method performs the actual work of the GeneratedContentCleaner by calling deleteFile with 'true' passed
   * down for the 'permanent' flag.
   * 
   * (non-Javadoc)
