...
public class PentahoBoot extends PentahoSystemBoot {
  ...
  public void enablePooledDatasources() {
    ...
    if ( objectFactory instanceof IPentahoDefinableObjectFactory ) {
      ...
      define( IDBPooledDatasourceService.class, PooledDatasourceService.class, Scope.LOCAL );
      define( IDBJndiDatasourceService.class, JndiDatasourceService.class, Scope.LOCAL );
    }
