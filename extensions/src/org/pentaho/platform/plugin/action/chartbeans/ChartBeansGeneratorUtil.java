...
public class ChartBeansGeneratorUtil {
  ...
  public static String createChartAsHtml(IPentahoSession userSession, Map<String, Object> parameterMap, String serializedChartDataDefinition,
  ...
  public static String createChartAsHtml(IPentahoSession userSession, Map<String, Object> parameterMap, String serializedChartDataDefinition,
      String serializedChartModel, int chartWidth, int chartHeight, String contentLinkingTemplate) throws IOException {
  	//TODO: temp!
    
  	return  ((DefaultChartBeansGenerator)generator).createChartAsHtml(userSession, parameterMap, serializedChartDataDefinition, serializedChartModel, chartWidth, chartHeight, contentLinkingTemplate);
  ...
  public static String mergeJFreeChartHtmlTemplate(File imageFile, String imageMap, String imageMapName, int chartWidth, int chartHeight, String contextPath) {
    return generator.mergeJFreeChartHtmlTemplate(imageFile, imageMap, imageMapName, chartWidth, chartHeight, contextPath); 
  }
