...
public class EmailConfiguration implements Serializable, IEmailConfiguration {
  ...
  public boolean equals(final Object obj) {
    ...
    return (
        this.authenticate == that.authenticate
            && this.debug == that.debug
            && this.smtpQuitWait == that.smtpQuitWait
            && this.useSsl == that.useSsl
            ...
            && isEquals(this.password, that.password));
  }
