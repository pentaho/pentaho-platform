...
public class EmailService {
  ...
  /**
   * The file which contains the email configuration information. This is guaranteed to be NOT NULL by
   * the setEmailConfigFile() method
   */
   ...
   *
   * @param emailConfigFile the file reference to the email configuration
   * @throws IllegalArgumentException indicates the argument is either null or references a location which is invalid
   *                                  (the parent folder of the specified file doesn't exist)
   */
  ...
  public void setEmailConfig(final EmailConfiguration emailConfiguration) throws Exception {
    ...
    try {
      ...
      logger.error(messages.getErrorString("EmailService.ERROR_0003_ERROR_CREATING_EMAIL_CONFIG_FILE",
  ...
  public EmailConfiguration getEmailConfig() {
    try {
      ...
      logger.error(messages.getErrorString("EmailService.ERROR_0004_LOADING_EMAIL_CONFIG_FILE",
          e.getLocalizedMessage()));
   ...
   *
   * @param emailConfigFile the email configuration file to use
   * @throws IllegalArgumentException indicates that the provided value is invalid (the value is null or the parent
  ...
  protected void setEmailConfigFile(final File emailConfigFile) throws IllegalArgumentException {
    ...
    if (emailConfigFile == null) {
      throw new IllegalArgumentException(messages.getErrorString(
          "EmailService.ERROR_0001_INVALID_CONFIG_FILE_LOCATION", null));
    }
