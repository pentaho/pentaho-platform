...
public class PerspectiveUtil {
  static IPluginPerspective createPerspective(Element perspectiveNode) {
    if (perspectiveNode != null) {
      String title = XmlDom4JHelper.getNodeText("title", perspectiveNode); //$NON-NLS-1$
      String id = XmlDom4JHelper.getNodeText("id", perspectiveNode); //$NON-NLS-1$
      String contentUrl = XmlDom4JHelper.getNodeText("content-url", perspectiveNode); //$NON-NLS-1$
