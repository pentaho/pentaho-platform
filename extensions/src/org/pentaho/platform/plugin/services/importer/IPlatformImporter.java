...
public interface IPlatformImporter {
  ...
  /**
   * Add a new IPlatformImportHandler to process the MimeTypes given by that import handler. An Import Handler registers
   * what MimeTypes it processes via the getMimeTypes() method. This IPlatformImporter then adds the MimeTypes to its
   * master list, and, adds the extensions handled by the mimetypes to the IPlatformImportResolver managed by this
   * class.
   **/
