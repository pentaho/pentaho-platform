...
public class XActionImportHandler extends RepositoryFileImportFileHandler implements IPlatformImportHandler {
	...
	public XActionImportHandler(List<String> approvedExtensionList, List<String> hiddenExtensionList) {
		super(approvedExtensionList, hiddenExtensionList);
	}

	/**
	 * This import hander was created with the sole purpose to honor the hidden
	 * flag for action-sequences which is controlled by the
	 * "/action-sequence/documentation/result-type" inside of the xaction
	 * definition.
	 * 
