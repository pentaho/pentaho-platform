...
/**
 * <p>Java class for jobScheduleRequest complex type.
 * 
 ...
 *         &lt;element name="complexJobTrigger" type="{http://www.pentaho.com/schema/}complexJobTriggerProxy" minOccurs="0"/>
 ...
 *         &lt;element name="jobParameters" type="{http://www.pentaho.com/schema/}jobScheduleParam" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "jobScheduleRequest", propOrder = {
    "actionClass",
    "complexJobTrigger",
    "cronJobTrigger",
    "duration",
...
public class JobScheduleRequest {
     ...
     * This is why there is not a <CODE>set</CODE> method for the jobParameters property.
     * 
     * <p>
