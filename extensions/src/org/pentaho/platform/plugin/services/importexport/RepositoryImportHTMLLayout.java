...
public class RepositoryImportHTMLLayout extends Layout {
  ...
  static protected final String fontCss = "font-family: arial,sans-serif; font-size: x-small";
  static protected final String thCss = "background: #336699; color: #FFFFFF; text-align: left";
