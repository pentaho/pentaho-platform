...
public class MondrianImportHandler implements ImportHandler {
  ...
  private void processSchema(ImportSource.IRepositoryFileBundle mondrianFile, String datasourceInfo) throws Exception {
    ...
    if(repository != null) {
    	org.pentaho.platform.plugin.services.importexport.legacy.MondrianCatalogRepositoryHelper helper = new org.pentaho.platform.plugin.services.importexport.legacy.MondrianCatalogRepositoryHelper(repository);
