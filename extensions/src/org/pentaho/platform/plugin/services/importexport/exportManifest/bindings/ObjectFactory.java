 ...
 * generated in the org.pentaho.platform.plugin.services.importexport.exportManifest.bindings package. 
...
public class ObjectFactory {
    ...
    private final static QName _IncrementalRecurrence_QNAME = new QName("http://www.pentaho.com/schema/", "incrementalRecurrence");
    private final static QName _JobScheduleRequest_QNAME = new QName("http://www.pentaho.com/schema/", "jobScheduleRequest");
    private final static QName _QualifiedDayOfMonth_QNAME = new QName("http://www.pentaho.com/schema/", "qualifiedDayOfMonth");
    private final static QName _ExportManifest_QNAME = new QName("http://www.pentaho.com/schema/", "ExportManifest");
    private final static QName _SimpleJobTrigger_QNAME = new QName("http://www.pentaho.com/schema/", "simpleJobTrigger");
    private final static QName _DatabaseType_QNAME = new QName("http://www.pentaho.com/schema/", "databaseType");
    private final static QName _CronJobTrigger_QNAME = new QName("http://www.pentaho.com/schema/", "cronJobTrigger");
    private final static QName _RecurrenceList_QNAME = new QName("http://www.pentaho.com/schema/", "recurrenceList");
    private final static QName _SequentialRecurrence_QNAME = new QName("http://www.pentaho.com/schema/", "sequentialRecurrence");
    private final static QName _PartitionDatabaseMeta_QNAME = new QName("http://www.pentaho.com/schema/", "partitionDatabaseMeta");
    private final static QName _DatabaseConnection_QNAME = new QName("http://www.pentaho.com/schema/", "databaseConnection");
    private final static QName _ComplexJobTriggerProxy_QNAME = new QName("http://www.pentaho.com/schema/", "complexJobTriggerProxy");
    private final static QName _QualifiedDayOfWeek_QNAME = new QName("http://www.pentaho.com/schema/", "qualifiedDayOfWeek");
    private final static QName _ComplexJobTrigger_QNAME = new QName("http://www.pentaho.com/schema/", "complexJobTrigger");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.pentaho.platform.plugin.services.importexport.exportManifest.bindings
     * 
     */
    ...
    public JAXBElement<IncrementalRecurrence> createIncrementalRecurrence(IncrementalRecurrence value) {
        return new JAXBElement<IncrementalRecurrence>(_IncrementalRecurrence_QNAME, IncrementalRecurrence.class, null, value);
    }
    ...
    public JAXBElement<SequentialRecurrence> createSequentialRecurrence(SequentialRecurrence value) {
        return new JAXBElement<SequentialRecurrence>(_SequentialRecurrence_QNAME, SequentialRecurrence.class, null, value);
    }
    ...
    public JAXBElement<PartitionDatabaseMeta> createPartitionDatabaseMeta(PartitionDatabaseMeta value) {
        return new JAXBElement<PartitionDatabaseMeta>(_PartitionDatabaseMeta_QNAME, PartitionDatabaseMeta.class, null, value);
    }
    ...
    public JAXBElement<ComplexJobTriggerProxy> createComplexJobTriggerProxy(ComplexJobTriggerProxy value) {
        return new JAXBElement<ComplexJobTriggerProxy>(_ComplexJobTriggerProxy_QNAME, ComplexJobTriggerProxy.class, null, value);
    }
