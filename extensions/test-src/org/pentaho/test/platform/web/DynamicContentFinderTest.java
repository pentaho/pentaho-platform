...
public class DynamicContentFinderTest {
    ...
    public void setUp() throws Exception {
      ...
      MondrianProperties.instance().DataSourceResolverClass.set(
        "org.pentaho.platform.web.servlet.PentahoDataSourceResolver");
    }
  ...
  public void testSingleInstanceForTwoRequests() throws Exception {
    ...
    final List<RepositoryContentFinder> finders =
      new ArrayList<RepositoryContentFinder>();

    final PentahoXmlaServlet servlet =
      new PentahoXmlaServlet() {
