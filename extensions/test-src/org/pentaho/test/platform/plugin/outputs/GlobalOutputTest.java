...
public class GlobalOutputTest extends BaseTest {
  ...
  public void testEmptyActionSequence() {
    ...
    try {
      ...
      IRuntimeContext runtimeContext = solutionEngine.execute(xactionStr,
          "SetGlobalOutputTest.xaction", "empty action sequence test", false, true, instanceId, false, parameterProviderMap, null, null, urlFactory, messages); //$NON-NLS-1$ //$NON-NLS-2$
