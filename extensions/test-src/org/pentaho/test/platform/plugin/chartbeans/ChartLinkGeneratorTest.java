...
public class ChartLinkGeneratorTest {
  ...
  public void testGenerateLinkEscapingSingleQuotes() {
    ...
    String generated = g.generateLink("1950's Chicago Surface Lines Streetcar", "1950's Chicago Surface Lines Streetcar", 8601);
    assertEquals("javascript:test('1950\\'s Chicago Surface Lines Streetcar', '1950\\'s Chicago Surface Lines Streetcar')", generated);
  ...
  public void testGenerateLinkNotEscapingSingleQuotes() {
    ...
    String generated = g.generateLink("1950's Chicago Surface Lines Streetcar", "1950's Chicago Surface Lines Streetcar", 8601);
    assertEquals("http://www.google.com/#hl=en&sugexp=crnk_lssbd&xhr=t&q=1950's Chicago Surface Lines Streetcar", generated);
  }
