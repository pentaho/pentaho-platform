...
public class StatsDatabaseCheckTest {
  ...
  public void testGetJobFileFullPath() throws Exception {
    when( appContext.getSolutionPath( "system" ) ).thenReturn( "test-res/FileOutputResourceTest/system" );
    statsDatabaseCheck.setJobFileName( "HelloWorld.kjb" );

    statsDatabaseCheck.getJobFileFullPath();
    assertEquals( "test-res/FileOutputResourceTest/system/HelloWorld.kjb", statsDatabaseCheck.getJobFileFullPath() );
  }
  ...
  public void testExecuteJob() throws Exception {
    ...
    String filePath = "test-res/FileOutputResourceTest/system/HelloWorld.kjb";
