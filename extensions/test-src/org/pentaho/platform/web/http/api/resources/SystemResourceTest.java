...
/*
  ...
  /**
   * Test that we get a valid document structure back. Make
   * sure the document contains the elements we expect. Since
   * we are not working with a real session, we don't need to check
   * real values.
   *
   * @throws Exception
   */
