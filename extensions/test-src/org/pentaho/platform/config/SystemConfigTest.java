...
public class SystemConfigTest {
  ...
  public void testSetConfiguration() throws Exception {
    ...
    IConfiguration c = new PropertiesFileConfiguration("test", new File("test-res/SystemConfig/system/test.properties"));
  ...
  public void testSpring() throws Exception {
    ...
    FileSystemXmlApplicationContext context = new FileSystemXmlApplicationContext("test-res/SystemConfig/system/testPropertyPlaceholders.spring.xml");
    context.refresh();
  ...
  public void testSystemSettingsFromSpring() throws Exception {
    ...
    FileSystemXmlApplicationContext context = new FileSystemXmlApplicationContext("test-res/SystemConfig/system/testPropertyPlaceholders-system-settings.spring.xml");
    context.refresh();
