...
public class MultipleComponentTest extends BaseTest {
   ...
   * assertEquals(colHeaders[0][0], "DEPARTMENT"); //$NON-NLS-1$ assertEquals(colHeaders[0][1], "Central");
   * //$NON-NLS-1$ assertEquals(colHeaders[0][2], "Western"); //$NON-NLS-1$ assertEquals(colHeaders[0][3], "Southern");
   * //$NON-NLS-1$ assertEquals(colHeaders[0][4], "Eastern"); //$NON-NLS-1$
   * 
   * finishTest(); }
   */
   ...
   * parameterProvider.setParameter("region", "Central"); //$NON-NLS-1$ //$NON-NLS-2$ testName = DS_TEST_NAME +
   * "report_" + System.currentTimeMillis(); //$NON-NLS-1$ context = run("test", "reporting",
   * "DynamicSQLSample.xaction", parameterProvider, testName, DS_TEST_EXTN); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
  ...
  public static void main( String[] args ) {
    ...
    try {
       ...
       * test.testSimpleRuntime(); test.testDataUtility(); test.testDataUtility1(); test.testDataUtility2();
       * test.testDataUtility3(); test.testDataUtility4(); test.testJVMParameterProvider();
       * test.testJVMParameterProviderDifferentPath(); test.testJVMParameterProviderDifferentPath2(); test.testUIUtil();
       */
