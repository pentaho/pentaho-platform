...
public class IPreparedComponentTest extends BaseTest {
   ...
   * 
   * IActionParameter rtn1 = context.getOutputParameter("a_result"); //$NON-NLS-1$ assertNotNull(rtn1);
   * IPentahoResultSet resultset1 = (IPentahoResultSet) rtn1.getValue(); assertEquals(1, resultset1.getRowCount());
   * assertEquals( "Expected first row of 'a_result' to contain a 1 in the first column.", new Integer(1),
   * resultset1.getValueAt(0, 0)); //$NON-NLS-1$
   * 
