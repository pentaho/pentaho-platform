...
public class PentahoMetadataFileInfoTest extends TestCase {
  ...
  private static String[] UNKNOWN_DATA = new String[]{
      null, "", " ", "metadata.xmi", "//\\//\\//\\//\\//\\//\\",
      "/metadata.xmi",
      "//metadata.xmi",
      "admin/resources/metadata/.xmi",
      "pentaho-solutions/steel-wheels/metadata.properties",
      "pentaho-solutions/steel-wheels/metadata_en_.properties",
      "pentaho-solutions/steel-wheels/metadata_en_US_.properties",
      "test/admin/resource/metadata/metadata.properties",
      "test/admin/resource/metadata/metadata_en_.properties",
...
//    final Matcher matcher = Pattern.compile(".*/([^/]+/resources/metadata/[^/]+)_([a-z]{2}_[A-Z]{2})\\.properties$").matcher(data);
