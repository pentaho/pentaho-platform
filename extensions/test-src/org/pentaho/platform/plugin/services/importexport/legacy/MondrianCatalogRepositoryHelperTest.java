...
public class MondrianCatalogRepositoryHelperTest {
  ...
  public static void setUpClass() throws Exception {
    MicroPlatform platform = new MicroPlatform( "test-src/solution" );
  ...
  public void testSchemaFilesWithoutAnnotations() throws Exception {
    FileSystemBackedUnifiedRepository repository =
        new FileSystemBackedUnifiedRepository( "test-res/MondrianCatalogRepositoryHelperTest" );
    ...
    assertSchemaFile(
        "test-res/MondrianCatalogRepositoryHelperTest/etc/mondrian/sample/schema.xml", schemaFiles.get( "schema.xml" ) );
  }
  ...
  public void testSchemaFilesContainsAnnotatedSchema() throws Exception {
    ...
    assertSchemaFile(
        "test-res/MondrianCatalogRepositoryHelperTest/etc/mondrian/food/schema.xml",
        schemaFiles.get( "schema.xml" ) );
    assertSchemaFile(
        "test-res/MondrianCatalogRepositoryHelperTest/etc/mondrian/food/annotations.xml",
        schemaFiles.get( "annotations.xml" ) );
    assertSchemaFile(
        "test-res/MondrianCatalogRepositoryHelperTest/schema.annotated.xml", schemaFiles.get( "schema.annotated.xml" ) );
  }
