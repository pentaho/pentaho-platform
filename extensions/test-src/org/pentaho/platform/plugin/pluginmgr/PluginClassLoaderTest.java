...
public class PluginClassLoaderTest {
  ...
  public void testOverrideLoad() throws ClassNotFoundException, SecurityException, InstantiationException,
    ...
    String className = "org.pentaho.platform.plugin.pluginmgr.ClassToOverride";
  ...
  private Object getContainerFromPrivateClassLoader() throws ClassNotFoundException, InstantiationException,
    IllegalAccessException {
    String className = "org.pentaho.platform.plugin.pluginmgr.ClassToOverrideContainer";
  ...
  public void testLoadClass() throws IOException, ClassNotFoundException {
    ...
    Class<?> testClass = pluginLoader.loadClass( "org.pentaho.platform.engine.services.TestClassForClassloader" );
    assertNotNull( "class is null", testClass );
    assertEquals( "wrong class", "org.pentaho.platform.engine.services.TestClassForClassloader", testClass.getName() );
  }
  ...
  public void testJarListedInClassLoader() throws ClassNotFoundException {
    ...
    pluginLoader.loadClass( "org.pentaho.platform.engine.services.TestClassForClassloader" );
  }
