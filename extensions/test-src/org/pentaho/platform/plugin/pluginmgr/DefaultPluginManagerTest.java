...
package org.pentaho.platform.plugin.pluginmgr;
...
import org.pentaho.platform.engine.core.EchoServiceBean;
...
public class DefaultPluginManagerTest {
  ...
  public void test9_ContentGenerationRegistration() throws ObjectFactoryException, PluginBeanException,
    ...
    assertNotNull( "Could not get content generator test9b by id", pluginManager.getContentGenerator( "test9btype",
      null ) );
  ...
  public void test17_getPluginIdForType() throws PlatformInitializationException, PluginBeanException {
    IPluginProvider provider = new IPluginProvider() {
      public List<IPlatformPlugin> getPlugins( IPentahoSession session ) throws PlatformPluginRegistrationException {
        ...
        cg1.setTitle( "test" );
        cg1.setClassname( "org.pentaho.platform.plugin.pluginmgr.ContentGenerator1" );
        p.addContentGenerator( cg1 );

        BeanDefinition beanDef =
          BeanDefinitionBuilder.rootBeanDefinition( "org.pentaho.platform.plugin.pluginmgr.ContentGenerator1" )
  ...
  public static class Tst5PluginProvider implements IPluginProvider {
    public List<IPlatformPlugin> getPlugins( IPentahoSession session ) throws PlatformPluginRegistrationException {
      ...
      p.addBean( new PluginBeanDefinition( "TestMockComponent", "org.pentaho.platform.engine.core.MockComponent" ) );
      p.addBean( new PluginBeanDefinition( "TestPojo", "java.lang.String" ) );
      p.addBean( new PluginBeanDefinition( "TestClassNotFoundComponent", "org.pentaho.NotThere" ) );
      return Arrays.asList( (IPlatformPlugin) p );
    }
  }
  ...
  public static class Tst9PluginProvider implements IPluginProvider {
    public List<IPlatformPlugin> getPlugins( IPentahoSession session ) throws PlatformPluginRegistrationException {
      ...
      BeanDefinition beanDef =
        BeanDefinitionBuilder.rootBeanDefinition( "org.pentaho.platform.plugin.pluginmgr.ContentGenerator1" ).setScope(
          BeanDefinition.SCOPE_PROTOTYPE ).getBeanDefinition();
  ...
  public static class Tst11PluginProvider implements IPluginProvider {
    public List<IPlatformPlugin> getPlugins( IPentahoSession session ) throws PlatformPluginRegistrationException {
      ...
      pws.setServiceBeanId( "org.pentaho.platform.engine.core.EchoServiceBean" );
      p.addWebservice( pws );

      // defining bean with null id, the classname will be used as the id
      p.addBean( new PluginBeanDefinition( null, "org.pentaho.platform.engine.core.EchoServiceBean" ) );
  ...
  public static class Tst14PluginProvider implements IPluginProvider {
    public List<IPlatformPlugin> getPlugins( IPentahoSession session ) throws PlatformPluginRegistrationException {
      ...
      pws.setServiceClass( "org.pentaho.platform.engine.core.EchoServiceBean" );
      p.addWebservice( pws );
