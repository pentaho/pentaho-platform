...
package org.pentaho.platform.plugin.chartbeans;
...
import org.pentaho.platform.engine.core.XmlSimpleSystemSettings;
...
public class ChartBeansSystemListenerTest {
  ...
  public void setUp() throws Exception {
    ...
    String solutionsRelativePath = "test-src/org/pentaho/platform/plugin/chartbeans/solutions";
  ...
  /**
   * Test method for
   * {@link org.pentaho.platform.plugin.action.chartbeans.ChartBeansSystemListener# startup(org.pentaho.platform.api.engine.IPentahoSession)}
   * .
   */
  @Test
