...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="doSubscriptions">
    ...
    <tr>
      <td class="portlet-font" colspan="2">
        <div> <!-- divSchMsg -->
          <xsl:attribute name="id">divSchMsg<xsl:value-of select="/filters/id"/>
          </xsl:attribute>
              ...
              <tr>
                <td>
                  <input type="button" name="subscribe1button" class="portlet-form-button">
                    ...
                    <xsl:attribute name="onClick">showSubscribe('<xsl:value-of select="/filters/id"/>')
                    </xsl:attribute>
                    <xsl:attribute name="id">subscribe1button<xsl:value-of select="/filters/id"/>
                    </xsl:attribute>
                    <xsl:choose>
      ...
      <tr>
        <td class="portlet-font" colspan="2">
          <div style="display:none"> <!-- subscribe-div -->
            <xsl:attribute name="id">subscribe-div<xsl:value-of select="/filters/id"/>
            </xsl:attribute>
            <xsl:choose>
              <xsl:when test="$editing='true'">
                <xsl:attribute name="style">display:block</xsl:attribute>
            ...
            <form>
              <xsl:attribute name="name">save_form_<xsl:value-of select="/filters/id"/>
              </xsl:attribute>
              ...
              <table width="100%" border="0">
                ...
                <tr>
                  <td class="portlet-font" colspan="1">
                    <br/>
                    <xsl:value-of select="msg:getXslString('UI.PARAM_FORM_UTIL.REPORT_NAME')"
                  ...
                  <td class="portlet-font" colspan="1">
                    ...
                    <input name="subscribe-name" class="portlet-form-field" size="50">
                      <xsl:attribute name="value">
                        <xsl:value-of select="/filters/input[@name='subscribe-title']/@value"/>
                      </xsl:attribute>
                ...
                <xsl:if test="count(/filters/schedules/schedule) > 0">
                  ...
                  <tr>
                    ...
                    <td class="portlet-font" colspan="1">
                      ...
                      <select>
                        <xsl:attribute name="id">monthly-schedule-selection-<xsl:value-of select="/filters/id"/>
                        </xsl:attribute>
                        ...
                        <xsl:for-each select="/filters/schedules/schedule">
                          ...
                          <option>
                            <xsl:attribute name="value">schedule-<xsl:value-of select="id"/>
                            </xsl:attribute>
                    ...
                    <xsl:choose>
                      <xsl:when test="$editing='true'">
                        <input type="button" name="save" class="portlet-form-button">
                          ...
                          <xsl:attribute name="onClick">doSave('<xsl:value-of select="/filters/id"/>', '<xsl:value-of
                              select="/filters/action"/>', false );
                          </xsl:attribute>
                        </input>
                        ...
                        <input type="button" name="save" class="portlet-form-button">
                          ...
                          <xsl:attribute name="onClick">doSave('<xsl:value-of select="/filters/id"/>', '<xsl:value-of
                              select="/filters/action"/>', true );
                          </xsl:attribute>
                        </input>
                        <input type="button" name="cancel" class="portlet-form-button">
                          <xsl:attribute name="value">Cancel Editing</xsl:attribute>
                          <xsl:attribute name="onClick">doCancelScheduling( '<xsl:value-of select="/filters/id"/>',
                            true)
                          </xsl:attribute>
                          <xsl:attribute name="id">cancel2button<xsl:value-of select="/filters/id"/>
                          </xsl:attribute>
                        </input>
                      </xsl:when>
                      <xsl:otherwise>
        ...
        <tr>
          <td colspan="3">
            <div style="display:block;border-top:0px solid #cccccc">
              ...
              <xsl:attribute name="id">subs1div<xsl:value-of select="/filters/id"/>
              </xsl:attribute>
              ...
              <div class="roundcont">
                ...
                <table width="50%" border="0">
                  ...
                  <tr>
                    <td>
                      <select>
                        <xsl:attribute name="id">subscription<xsl:value-of select="/filters/id"/>
                        </xsl:attribute>
                    ...
                    <td class="portlet-font">
                      <select>
                        <xsl:attribute name="id">subscription-action<xsl:value-of select="/filters/id"/>
                        </xsl:attribute>
                    ...
                    <td align="left">
                      <input type="button" name="go" class="portlet-form-button">
                        ...
                        <xsl:attribute name="onClick">doSubscribed('<xsl:value-of select="/filters/id"/>',
                          '<xsl:value-of select="/filters/action"/>', '<xsl:value-of select="/filters/display"/>')
                        </xsl:attribute>
                      </input>
                    </td>
                  ...
                  <xsl:if test="count(/filters/subscriptions/subscription/archives/archive)&gt;0">
                    ...
                    <tr>
                      <td>
                        <select>
                          <xsl:attribute name="id">subscription-archive<xsl:value-of select="/filters/id"/>
                          </xsl:attribute>
                      ...
                      <td class="portlet-font">
                        <select>
                          <xsl:attribute name="id">subscription-archive-action<xsl:value-of select="/filters/id"/>
                          </xsl:attribute>
                      ...
                      <td>
                        <input type="button" name="go" class="portlet-form-button">
                          <xsl:attribute name="value">Go</xsl:attribute>
                          <xsl:attribute name="onClick">doSubscribedArchive('<xsl:value-of select="/filters/id"/>',
                            '<xsl:value-of select="/filters/action"/>')
                          </xsl:attribute>
                        </input>
                      </td>
                    </tr>
  ...
  <xsl:template name="archive">
    <xsl:for-each select="archives/archive">
      <option>
        <xsl:attribute name="value"><xsl:value-of select="../../id"/>:<xsl:value-of select="id"/>
        </xsl:attribute>
        <xsl:value-of select="../../title"/> :
