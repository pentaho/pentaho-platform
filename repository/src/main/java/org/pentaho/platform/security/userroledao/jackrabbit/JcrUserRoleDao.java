...
public class JcrUserRoleDao extends AbstractJcrBackedUserRoleDao {
  ...
  public static final String JCR_USER_ROLE_DAO_ERROR_0008_LISTING_ROLES = "JcrUserRoleDao.ERROR_0008_LISTING_ROLES";
  public static final String JCR_USER_ROLE_DAO_ERROR_0006_UPDATING_USER = "JcrUserRoleDao.ERROR_0006_UPDATING_USER";
  public static final String JCR_USER_ROLE_DAO_ERROR_0010_GETTING_ROLE = "JcrUserRoleDao.ERROR_0010_GETTING_ROLE";
  public static final String JCR_USER_ROLE_DAO_ERROR_0001_UPDATING_ROLE = "JcrUserRoleDao.ERROR_0001_UPDATING_ROLE";
  ...
  public void setRoleMembers( final ITenant tenant, final String roleName, final String[] memberUserNames ) {
    try {
      ...
      throw new UncategorizedUserRoleDaoException( Messages.getInstance().getString(
        JCR_USER_ROLE_DAO_ERROR_0001_UPDATING_ROLE, e.getLocalizedMessage() ), e );
    }
  }
  ...
  @Override
  public void setUserRolesNoValidation(final ITenant tenant, final String userName, final String[] roles )
          throws NotFoundException, UncategorizedUserRoleDaoException {
    ...
    try {
      ...
      adminJcrTemplate.execute( new JcrCallback() {
        @Override
        public Object doInJcr( Session session ) throws IOException, RepositoryException {
          setUserRolesNoValidation( session, tenant, userName, roles );
          return null;
        }
      } );
    } catch ( DataAccessException e ) {
  ...
  @Override
  public IPentahoUser createOAuthUser( final ITenant tenant,
    ...
    try {
      ...
      user = (IPentahoUser) adminJcrTemplate.execute( new JcrCallback() {
        @Override
        public Object doInJcr( Session session ) throws IOException, RepositoryException {
          PentahoUser pentahoUser = new PentahoUser( tenant, userName, password, description, false );
          PentahoOAuthUser pentahoOAuthUser = new PentahoOAuthUser( pentahoUser, registrationId, userId );
          return createOAuthUser( session, tenant, roles, pentahoOAuthUser );
        }
      } );
    } catch ( DataAccessException e ) {
      if ( ( e instanceof JcrSystemException ) && ( e.getCause() instanceof AuthorizableExistsException ) ) {
  ...
  public void setUserDescription( final ITenant tenant, final String userName, final String description )
    ...
    try {
      ...
      throw new UncategorizedUserRoleDaoException( Messages.getInstance().getString(
        JCR_USER_ROLE_DAO_ERROR_0006_UPDATING_USER, e.getLocalizedMessage() ), e );
    }
  }
  ...
  public List<IPentahoRole> getRoles( final ITenant tenant, final boolean includeSubtenants )
    ...
    try {
      ...
      throw new UncategorizedUserRoleDaoException( Messages.getInstance().getString(
        JCR_USER_ROLE_DAO_ERROR_0008_LISTING_ROLES, e.getLocalizedMessage() ), e );
    }
  }
  ...
  public IPentahoRole getRole( final ITenant tenant, final String name ) throws UncategorizedUserRoleDaoException {
    try {
      ...
      throw new UncategorizedUserRoleDaoException( Messages.getInstance().getString(
        JCR_USER_ROLE_DAO_ERROR_0010_GETTING_ROLE, e.getLocalizedMessage() ), e );
    }
  }
    ...
    try {
      ...
      adminJcrTemplate.execute( new JcrCallback() {
        ...
        public Void doInJcr( Session session ) throws IOException, RepositoryException {
          changeUserStatus( session, pentahoUser );
          return null;
        }
      } );
    } catch ( DataAccessException e ) {
