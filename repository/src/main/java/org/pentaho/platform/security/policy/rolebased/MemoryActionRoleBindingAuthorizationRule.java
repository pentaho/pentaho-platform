...
/**
 * An in-memory implementation of the {@link ActionRoleBindingAuthorizationRule} that allows for overriding persisted
 * role bindings with a provided map of role to action bindings.
 */
