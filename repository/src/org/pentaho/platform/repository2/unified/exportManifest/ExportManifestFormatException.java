 ...
 * XML values that are not caught by JAXB will represented by this object.
 * It should be assumed that if this exception is thrown then the message
 * will contain text that is localized and suitable for an Import Exception
 * log.
 * 
 * @author tkafalas
 */
