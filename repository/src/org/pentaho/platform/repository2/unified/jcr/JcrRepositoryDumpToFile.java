...
public class JcrRepositoryDumpToFile {
  ...
  public enum Mode { CUSTOM, SYS, DOC };
  ...
  public JcrRepositoryDumpToFile(final JcrTemplate jcrTemplate, TransactionTemplate txnTemplate, String repositoryAdminUsername, String filename, Mode mode) {
