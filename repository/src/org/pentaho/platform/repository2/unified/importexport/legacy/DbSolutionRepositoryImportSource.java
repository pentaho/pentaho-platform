    ...
    private class DbsrRowCallbackHandler implements RowCallbackHandler {
      ...
      public void processRow(final ResultSet rs) throws SQLException {
        ...
        if (!id.equals(lastId)) {
          ...
          if (lastId != null) { // prevent adding to batch on first row
            ...
            currentBatch.add(new RepositoryFileBundle(currentFile, currentAclBuilder != null ? currentAclBuilder
      ...
      private void flushBatch() {
        if (currentFile != null) { // save the last file to the batch
          currentBatch.add(new RepositoryFileBundle(currentFile, currentAclBuilder != null ? currentAclBuilder.build()
