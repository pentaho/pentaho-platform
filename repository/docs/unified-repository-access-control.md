...
> Sourced from the companion analysis in `permission-model.md` — included here because it
...
> see **[`unified-repository-access-control-disambiguation.md`](./unified-repository-access-control-disambiguation.md)**,
...
Moved to a dedicated file — **[`unified-repository-access-control-disambiguation.md`](./unified-repository-access-control-disambiguation.md)** —
