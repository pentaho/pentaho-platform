...
public class DatasourceMgmtToWebServiceAdapterTest  extends TestCase {
  ...
  public void testEverything() throws Exception {
    adapter.createDatasource(createDatabaseConnection("testDatabase"));
    ...
    adapter.createDatasource(createDatabaseConnection("testDatabase1"));
    IDatabaseConnection databaseConnection1 = adapter.getDatasourceByName("testDatabase1");
    ...
    adapter.updateDatasourceByName("testDatabase", databaseConnection);
    ...
    adapter.deleteDatasourceByName("testDatabase");
    IDatabaseConnection deletedDatabaseConnection = adapter.getDatasourceByName("testDatabase");
