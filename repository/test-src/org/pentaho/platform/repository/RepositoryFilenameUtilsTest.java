...
public class RepositoryFilenameUtilsTest extends TestCase {
  ...
  public void testIsExtensionCollection() {
    ...
    assertEquals(true, RepositoryFilenameUtils.isExtension("file.txt", new ArrayList(Arrays.asList(new String[]{"txt"}))));
    assertEquals(false, RepositoryFilenameUtils.isExtension("file.txt", new ArrayList(Arrays.asList(new String[]{"rtf"}))));
    assertEquals(true, RepositoryFilenameUtils.isExtension("file", new ArrayList(Arrays.asList(new String[]{"rtf", ""}))));
    assertEquals(true, RepositoryFilenameUtils.isExtension("file.txt", new ArrayList(Arrays.asList(new String[]{"rtf", "txt"}))));
    ...
    assertEquals(true, RepositoryFilenameUtils.isExtension("a/b/file.txt", new ArrayList(Arrays.asList(new String[]{"txt"}))));
    assertEquals(false, RepositoryFilenameUtils.isExtension("a/b/file.txt", new ArrayList(Arrays.asList(new String[]{"rtf"}))));
    assertEquals(true, RepositoryFilenameUtils.isExtension("a/b/file.txt", new ArrayList(Arrays.asList(new String[]{"rtf", "txt"}))));
    ...
    assertEquals(false, RepositoryFilenameUtils.isExtension("a.b\\file.txt", new ArrayList(Arrays.asList(new String[]{"TXT"}))));
    assertEquals(false, RepositoryFilenameUtils.isExtension("a.b\\file.txt", new ArrayList(Arrays.asList(new String[]{"TXT", "RTF"}))));
  }
