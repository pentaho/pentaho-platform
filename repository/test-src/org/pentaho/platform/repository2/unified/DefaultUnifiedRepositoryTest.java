...
public class DefaultUnifiedRepositoryTest implements ApplicationContextAware {
  ...
  public void testUndeleteFile() throws Exception {
    ...
    assertNull( repo.getFile( "/home/suzy/test2/helloworld.sample" ) ); // repo should create any missing folders on
                                                                        // undelete
  ...
  public void testGetAcl() throws Exception {
    ...
    newAcl =
        new RepositoryFileAcl.Builder( acl ).ace( userNameUtils.getPrincipleId( tenantAcme, USERNAME_TIFFANY ),
            RepositoryFileSid.Type.USER, RepositoryFilePermission.READ ).build(); // calling ace sets entriesInheriting
                                                                                  // to false
