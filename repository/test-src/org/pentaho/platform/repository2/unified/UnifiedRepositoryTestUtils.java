 ...
 * 
 * <p>Stubbing Examples:</p>
 * <p>1. Stub getFile and getDataForRead:</p>
 * <pre>
 ...
 * <p>1. Verify that createFile was called:</p>
 * <pre>
...
public class UnifiedRepositoryTestUtils {
  ...
  /**
   * Stubs a {@code getChildren} call. {@code childrenNames} is zero or more file/folder names. A folder is indicated
   * by a trailing forward slash. 
   * 
   * <p>Example:</p>
   * <pre>stubGetChildren(repo, "/public", "hello/", "file1.txt");</pre>
   */
  public static void stubGetChildren(final IUnifiedRepository repo, final String path, final String... childrenNames) {
    ...
    for (String childName : childrenNames) {
      ...
      final String fullChildPath = path
  ...
  public static void stubGetData(final IUnifiedRepository repo, final String path, final String text) {
    ...
    doReturn(new AutoResetSimpleRepositoryFileData(new ByteArrayInputStream(bytes), encoding, getMimeType(path))).when(
   ...
   * 
   * <p>Example:</p>
   * <pre>stubGetTree(repo, "/public", "relUrlTest.url", "hello/file.txt", "hello/file2.txt", "hello2/");</pre>
   */
  ...
  private static void addChild(final RepositoryFileTree.Builder root, final boolean leafIsFolder,
    ...
    String reconstructedPath = root.getFile().getPath() + RepositoryFile.SEPARATOR
