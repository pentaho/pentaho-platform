...
public class NonPooledDatasourceSystemListener implements IPentahoSystemListener, ICacheManagerUser {
  ...
  protected ICacheManager addCacheRegions() {
    ...
    if ( !getCacheManager().cacheEnabled( IDBDatasourceService.JDBC_DATASOURCE ) ) {
      getCacheManager().addCacheRegion( IDBDatasourceService.JDBC_DATASOURCE );
    }
