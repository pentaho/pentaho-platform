...
public class ResourceActionGeneralRequirementAuthorizationDecisionTest {
  ...
  public void testConstructorAndGetters() {
    ...
    assertSame( grantedDecision, grantedRequirementDecision.getImpliedFromDecision() );
    ...
    assertSame( deniedDecision, deniedRequirementDecision.getImpliedFromDecision() );
  }
