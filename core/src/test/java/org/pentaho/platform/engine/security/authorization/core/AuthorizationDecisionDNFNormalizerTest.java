...
public class AuthorizationDecisionDNFNormalizerTest {
  ...
  private static class DecisionEqualityComparer implements EqualityComparer<IAuthorizationDecision> {
    ...
    public boolean equals( @NonNull IAuthorizationDecision a, @NonNull IAuthorizationDecision b ) {
      ...
      if ( baseTypeA == IImpliedAuthorizationDecision.class ) {
        return equals( (IImpliedAuthorizationDecision) a, (IImpliedAuthorizationDecision) b );
      }
    ...
    private boolean equals( @NonNull IImpliedAuthorizationDecision opposedA,
                            @NonNull IImpliedAuthorizationDecision opposedB ) {
      return equals( opposedA.getImpliedFromDecision(), opposedB.getImpliedFromDecision() );
    }
  }
  // endregion
}
