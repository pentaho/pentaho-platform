...
public class SequenceDefinition implements ISequenceDefinition {
  ...
  public static IActionSequence ActionSequenceFactory(final Document document,
      final String solutionPath, final ILogger logger,
    ...
    ISequenceDefinition seqDef = new SequenceDefinition(sequenceDefinitionNode, solutionPath,
  ...
  private SequenceDefinition(final Node sequenceRootNode, final String solutionPath, final ILogger logger, final IApplicationContext applicationContext) {
