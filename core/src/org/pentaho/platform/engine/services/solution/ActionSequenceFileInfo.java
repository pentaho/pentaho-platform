...
public class ActionSequenceFileInfo implements ISolutionFileMetaProvider {
  ...
  public IFileInfo getFileInfo(ISolutionFile solutionFile, InputStream in) {
    try {
      ...
      IActionSequence actionSequence = SequenceDefinition.ActionSequenceFactory(actionSequenceDocument, path,
          logger, PentahoSystem.getApplicationContext(), Logger.getLogLevel());
