 ...
 * 
 * <p>
 * Configure using system property {@code pentaho.requuestContextHolder.strategy} or {@link #setStrategyName(String)}. Valid 
...
public class PentahoRequestContextHolder {
     ...
     * It is important that the framework calls this to prevent RequestContext bleed-
