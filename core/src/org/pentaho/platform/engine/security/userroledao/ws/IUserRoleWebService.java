...
/**
 * This webservice interface may be used in the platform to expose the management 
 * of users and roles, it is a webservices compatible concrete form of IUserRoleDao.
 *
...
public interface IUserRoleWebService {
  ...
  /**
   * This updates the named role's attributes.  It is named differently than the IUserRoleDao because of issues
   * with webservice method overloading.
   * 
