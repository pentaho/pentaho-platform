...
/**
 * A utility for consistent interaction with {@link IAction}s.  Based
 * on {@link BeanUtil}, but with logic specific to {@link IAction} beans.
 * One such behavior is the setting of pass-through properties to an {@link IVarArgsAction}.
...
public class ActionHarness extends BeanUtil {
   ...
   * undeclared properties to the action bean if it is a {@link IVarArgsAction}.
   * <p>
   * {@inheritDoc}
   */
