...
/**
 * This interface is used in conjunction with {@link BeanUtil#setValue(Object, String, ValueSetCallback, PropertyNameFormatter...)}
...
public interface ValueSetErrorCallback {
   ...
   * @param bean the bean on which the value set operation was attempted
   * @param propertyName  the name of the property that failed to set on the bean
   * @param value  the value that the bean utility attempted to set on the bean
   * @param beanPropertyType  the type of the bean property on which we tried to set the value.  This may
   * not be the same type as that of the value.
   * @param cause  the reason for the failure
   * @throws ActionExecutionException  throw this exception if you consider this a terminal condition
   */
   ...
   * @param bean the bean on which write test was performed
   * @param propertyName  the name of the property that is not writable on the bean
   * @throws Exception  throw an exception if you consider this to be a terminal condition
   */
