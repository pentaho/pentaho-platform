...
public class PentahoBeanScopeValidatorPostProcessorTest extends BaseTest {
  ...
  /*
   * The following are bean ids for beans that have no explicit scope declared;
   * these are  in files scattered through core/test-res/solution/system ( pentahoObjects.spring.xml, adminPlugins.xml,
   * pentahoSystemConfig.xml, .. )
   */
  private static final String[] BEAN_IDS_WITH_NO_EXPLICIT_SCOPE_DEFINED = new String[]{
    "mimeListenerCollection", "pentahoSystemProxy", "administrationPluginsList"
  };
