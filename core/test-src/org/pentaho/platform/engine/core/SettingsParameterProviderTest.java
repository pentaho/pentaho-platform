...
public class SettingsParameterProviderTest extends TestCase {
	...
	public void testSystemSettingsParameterProvider1() {
		...
		String value = SystemSettingsParameterProvider
				.getSystemSetting("pentaho.xml{pentaho-system/log-file}");

		assertEquals("Could not get setting from pentaho.xml", "server.log",
				value);
	}
	...
	public void testSystemSettingsParameterProvider2() {
		...
		String value = provider.getStringParameter(
		...
		value = (String) provider
				.getParameter("pentaho.xml{pentaho-system/log-file}");
		assertEquals("Could not get setting from pentaho.xml", "server.log",
				value);
	...
	public void testSystemSettingsParameterProvider3() {
		...
		String value = provider.getStringParameter(
				"bogus.xml{pentaho-system/log-file}", null);
	...
	public void testCustomSettingsParameterProvider() {
		...
		String value = provider.getStringParameter(
				"settings.xml{settings/setting1}", null);
		...
		value = (String) provider
				.getParameter("settings.xml{settings/{$user}/setting2}");
