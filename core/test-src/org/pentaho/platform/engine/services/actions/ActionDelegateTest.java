...
public class ActionDelegateTest {
  ...
  private void execute(String actionSequenceFile, boolean exceptionOnError, IAction... actions)
     ...
     */
    IRuntimeContext rc = solutionEngine.execute(xactionStr, actionSequenceFile,
        "action sequence to test the TestAction", false, true, null, false, new HashMap(), outputHandler, null,
        new SimpleUrlFactory(""), new ArrayList());
